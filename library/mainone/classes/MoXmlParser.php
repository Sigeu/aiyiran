 ...
 * xml文件解析
 *
 * @author leishaojin <leishaojin2012@163.com>
 * @copyright ©2003-2003 mocms.com
 * @license http://www.mocms.com
 * @version $Id: MoXmlParser.php 4 2013-08-09 06:50:51Z zhoulifeng $
 * @package parser
 */
class MoXmlParser
{
	...
	{
		if (!class_exists('DOMDocument')) throw new Exception('MoXmlParser DOMDocument is not exist.');
	...
	public function parseToXml($source, $charset = 'utf8') {
		switch (gettype($source)) {
			...
			case 'array':
				...
				break;
			case 'string':
				$source = iconv($source, 'utf8', $charset);
			default:
