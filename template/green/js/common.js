$(function(){
	...
	/*管理设置隐藏层*/
	var mask="<div class='mask_pos'><div class='mask_pos_div'></div><span><a href='javascript:void(0)' onclick='control(this);'>管理</a><em>&nbsp;|&nbsp;</em><a href='javascript:void(0)' onclick='disappear(this);' class='js_hide'>隐藏</a></span></div>"
	$('div').filter().hover(function(){
		if($('body.edit').length>0&&$(this).find('.mask_pos').length<1){
			$(this).append($(mask));
