		...
		<div class="login_top">
		  ...
		  <div class="set_box">
		  	<div class="set_cont">
		  		...
		  		<div class="su_box su_box2">
		  		<p class="icon_tp"><span><img src="<?php echo IMG_PATH;?>/rt_03.png" /></span></p>
		  		<p class="tips_w">密码修改成功</p>
		  		<p class="an_tips"><a href="/">重新登录</a><a href="/">返回首页</a></p>
		  	</div>
		  	</div>
		  </div>
