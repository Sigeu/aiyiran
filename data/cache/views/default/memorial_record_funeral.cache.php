...
<script src="/template/default/member/layer/layer.js"></script>
            <div class="biography_details">
                <div class="details">
                    <div class="top_title">
                        <a href="/jinian/Jinian/funeral/mid/<?php echo $mid;?>">返回祭文列表页</a>
                        <h2><?php echo Template::addquote($funeral_info['ename']);?></h2>
                        <p><!-- 发布人：admin -->  阅读(<?php echo Template::addquote($funeral_info['click_nums']);?>) │ 评论(<?php echo $nums;?>)  发布时间：<?php echo Template::addquote($funeral_info['createtime']);?></p>
                    </div>
                    <div class="details_cont" style="margin-bottom: 30px;">
                            <?php echo Template::addquote($funeral_info['econtent']);?>
                    </div>
                        ...
                        <?php $n=1;foreach($lists AS $k => $v) { $lastIndex= count($lists) == $n;?>
                            <li>
                                ...
                                <div class="replys" style="display:none;">
                                    ...
                                    <div class="liu-icon"><a href="javascript:;" onclick="rep(<?php echo Template::addquote($v['id']);?>, '<?php echo Template::addquote($v['username']);?>', <?php echo $mid;?>)" class="btn btn-primary">评论</a><a href="javascript:;" class="btn btn-default cancelinfo">取消</a></div>
                                </div>
