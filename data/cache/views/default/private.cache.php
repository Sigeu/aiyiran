<?php if(!defined('IN_MAINONE')) exit(); ?>
            <div class="three_list">
                <div class="cont_list cont_list5">
                    ...
                    <ul class="">
                    <?php $tag_obj = Load::load_tag('memorial');if(!is_object($tag_obj)){halt('tag memorial is exists!');};$getParams = $_GET;if (isset($getParams["page"])) {unset($getParams["page"]);}$params = "";foreach ($getParams as $key => $val) {if (is_string($val)) {$params .= $key."=".$val . "&";}}$request_url = '?&'.$params.'page=$page';$count = $tag_obj -> lib_memorial (array('catid'=>'1','field'=>'id,userpic,personname,persontype,family_ranking','return'=>'data',));$currentPage =  @$_GET["page"] ? $_GET["page"] : 1;$from = 10*($currentPage-1);$url = $request_url;$pagesize = 10;$subpage = 10;$pagenum = count($count);$page = new Pages(10,$pagenum,$url,'page',$currentPage,$subpage);$pagestr = $page->show();$enpagestr = str_replace("首页", "Home", $pagestr);$enpagestr = str_replace("尾页", "Last", $enpagestr);$enpagestr = str_replace("上一页", "Prev", $enpagestr);$enpagestr = str_replace("下一页", "Next", $enpagestr);$pattern = "/第(\s*)(\d*)(\s*)页/i";$replacement = 'Page ${2}';$enpagestr = preg_replace($pattern, $replacement, $enpagestr);$enpagestr = str_replace("共", "Total", $enpagestr);$enpagestr = str_replace("页", "Page", $enpagestr);$pageArr = array(
				...
				"nextPageUrl"=>$page->nextPageUrl,
			);$data= $tag_obj -> lib_memorial (array('catid'=>'1','field'=>'id,userpic,personname,persontype,family_ranking','return'=>'data','from'=>$from,'pagesize'=>'10',));?>
                      <?php $n=1;foreach($data AS $key => $val) { $lastIndex= count($data) == $n;?>
                        ...
                        <li class="">
                            <em><?php echo $key;?></em>
                        <?php } ?>
                            <a href="###"><?php echo Template::addquote($val['personname']);?> </a>
                            <span>亲情值：<?php echo Template::addquote($val['family_ranking']);?></span>
                        </li>
                      <?php $n++;} ?>
                ...
                <div class="cont_list">
                    ...
                    <ul class="">
                        ...
                        <li>
                            <a href="###">前NBA球员吉拉尼去世 享去世 </a>
                            <span>2016-06-19</span>
                        </li>
                        <li>
                            <a href="###">前NBA球员吉拉尼去世 享年62岁多 </a>
                            <span>2016-06-19</span>
                        </li>
                        <li>
                            <a href="###">前NBA球员吉拉尼去世 享年62岁多 </a>
