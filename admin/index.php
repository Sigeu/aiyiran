 ...
 * @version    SVN: $Id: index.php 1198 2014-01-16 07:10:04Z zhoulifeng $
 ...
 * 项目根路径
 */
define('WEB_ROOT', str_replace(APPNAME,'',dirname(__FILE__)));
/**
 * 项目静态文件
 */
define('DIR_STATIC', WEB_ROOT . 'static' . DIRECTORY_SEPARATOR);

/**
 * 项目上传目录
 */
define('DIR_UPLOADFILE', WEB_ROOT . 'static/uploadfile' . DIRECTORY_SEPARATOR);

/**
 * 项目上传目录
 */
define('DIR_UPLOAD_TEMP', WEB_ROOT . 'static/uploadfile/temp' . DIRECTORY_SEPARATOR);

/**
 * 基础架构根目录
 */
$dir_bf_root	= WEB_ROOT . 'library/mainone' . DIRECTORY_SEPARATOR;

$dir_web_root  	= DIR_ROOT;
