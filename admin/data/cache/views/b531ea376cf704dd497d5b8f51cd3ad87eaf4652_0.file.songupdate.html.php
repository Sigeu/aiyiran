<?php
/* Smarty version 3.1.30, created on 2017-02-07 16:01:44
  from "D:\xampp\htdocs\aiyiran\admin\template\memorial\moreset\songupdate.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58997ee8cd5b80_78410452',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b531ea376cf704dd497d5b8f51cd3ad87eaf4652' => 
    array (
      0 => 'D:\\xampp\\htdocs\\aiyiran\\admin\\template\\memorial\\moreset\\songupdate.html',
      1 => 1478576678,
      2 => 'file',
    ),
  ),
...
function content_58997ee8cd5b80_78410452 (Smarty_Internal_Template $_smarty_tpl) {
...
/memorial/moreset/song">背景音乐列表</a></dt>
                   <dd  class="on"><a href="#" class="last">添加背景音乐</a></dd>
                </dl>
            </div>

            <form action='<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/memorial/moreset/songupdate' method='post' id='myform'>
                <div class="TabBoxC">
                    <div>
                        <div class="pubTabel">
                            <table class="tabelLR">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['findData']->value['name'];?>
" class="Iw290" name='name' id='name'/>&nbsp;<span id='nameTip'></span>
                               ...
                               <tr id="webLogo">
                                ...
                                <tr>
                                    <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审核：</th>
                                    <td>
                                     <span><input type="radio" name="status" value="1" <?php if ($_smarty_tpl->tpl_vars['findData']->value['status'] == 1) {?> checked="" <?php }?>><label>通过</label></span>
                                     <span><input type="radio" name="status" value="2" <?php if ($_smarty_tpl->tpl_vars['findData']->value['status'] == 2) {?>checked="" <?php }?>><label>否</label></span>
                                    </td>
                                </tr>
                                <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['findData']->value['id'];?>
">
                            </table>
