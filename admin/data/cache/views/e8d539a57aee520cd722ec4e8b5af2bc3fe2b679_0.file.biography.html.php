<?php
/* Smarty version 3.1.30, created on 2016-12-29 16:07:12
  from "D:\xampp\htdocs\aiyiran\admin\template\memorial\audit\biography.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5864c43064c185_16836637',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e8d539a57aee520cd722ec4e8b5af2bc3fe2b679' => 
    array (
      0 => 'D:\\xampp\\htdocs\\aiyiran\\admin\\template\\memorial\\audit\\biography.html',
      1 => 1480416169,
      2 => 'file',
    ),
  ),
...
function content_5864c43064c185_16836637 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
/memorial/audit/biography" class="last">传记管理</a></dt>
          </dl>
        </div>

         <form  method='get' action="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/memorial/audit/biography" id='myForm'>
        <!-- 搜索区域 -->
...
?>
                <tr>
                  <td>
                    <input type="checkbox" name="mid[]" value='<?php echo $_smarty_tpl->tpl_vars['item']->value['mid'];?>
' />
                  </td>
                  <td><?php echo $_smarty_tpl->tpl_vars['item']->value['bioname'];?>
</td>
...
if ($_smarty_tpl->tpl_vars['item']->value['status'] == 2) {?>未通过<?php }?></td>
                  <td>
                    <a href="javascript:;" class="shenhe" data="<?php echo $_smarty_tpl->tpl_vars['item']->value['mid'];?>
">审核</a> |
                    <a href="javascript:;"  onclick="MoConfirm('<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/memorial/audit/biographydelete/mid/<?php echo $_smarty_tpl->tpl_vars['item']->value['mid'];?>
...
/memorial/audit/biographydelete" empty-tips="请选择要删除的数据" confirm-tips="确认删除？"/>
            </div>
            *最多可添加5条规则
