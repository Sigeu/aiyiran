...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var array
     */
    protected $template_dir = array(DIR_VIEW);
     ...
     * @var array
     */
    protected $config_dir = array(DIR_CONFIG);
     ...
     * @var string
     */
    protected $compile_dir = 'data/cache/views/';
     ...
     * @var string
     */
    protected $cache_dir = 'data/cache/data/';
    ...
    public function __construct()
    {
		...
		$this->compile_dir 		= DIR_WEB_ROOT . 'data/cache/views/';
		$this->cache_dir 		= DIR_WEB_ROOT . 'data/cache/data/';
